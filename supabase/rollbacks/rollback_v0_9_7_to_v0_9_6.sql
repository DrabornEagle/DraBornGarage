-- DraBornGarage v0.9.7 -> v0.9.6 rollback
-- Motor Hazır aşamasındaki ücret zorunluluğunu kaldırır;
-- yalnız Teslim Edildi öncesi son net fiyat korumasını geri getirir.
