...
replaceRequired('src/AppShell.tsx', '      <NotificationBell />', "      {tab !== 'home' && <NotificationBell />}");
...
replaceRequired(platformFile, '>Platform Ödeme Bilgileri</Text>', '>Banka ve IBAN Bilgileri</Text>');
replaceRequired(
  platformFile,
...
for (const file of ['docs/V087_PLAN.md', 'docs/.v087_marker', 'docs/V087_WORKING_BRANCH_NOTE.md', 'docs/.keep-v087', 'docs/.v087-start']) if (fs.existsSync(file)) fs.rmSync(file);
