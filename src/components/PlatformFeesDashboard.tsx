...
const styles = StyleSheet.create({
  ...
  loading: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 9 }, loadingText: { fontSize: 11, fontWeight: '800' }, empty: { textAlign: 'center', paddingVertical: 10, fontSize: 11.5 },
  sectionHeader: { flexDirection: 'row', alignItems: 'center', gap: 10 }, sectionTitle: { fontSize: 19, fontWeight: '900' }, sectionSub: { fontSize: 10.5, marginTop: 4 }, refresh: { width: 42, height: 42, borderWidth: 1, borderRadius: 14, alignItems: 'center', justifyContent: 'center' },
  hero: { minHeight: 154, borderRadius: 27, padding: 20, flexDirection: 'row', alignItems: 'center', gap: 12 }, heroEyebrow: { color: 'rgba(255,255,255,0.82)', fontSize: 9.5, fontWeight: '900', letterSpacing: 1 }, heroValue: { color: '#fff', fontSize: 31, fontWeight: '900', marginTop: 8 }, heroSub: { color: 'rgba(255,255,255,0.76)', fontSize: 10.5, marginTop: 5 }, heroRight: { alignItems: 'flex-end', gap: 10 }, heroRightText: { color: '#fff', fontSize: 9.5, lineHeight: 15, textAlign: 'right', fontWeight: '800' },
  adminHero: { minHeight: 132, borderRadius: 25, padding: 18, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }, adminHeroValue: { color: '#fff', fontSize: 28, fontWeight: '900', marginTop: 7 }, businessRow: { gap: 9, paddingRight: 8 }, businessCard: { width: 215, minHeight: 112, borderRadius: 19, borderWidth: 1, padding: 13, gap: 7 }, businessHead: { flexDirection: 'row', alignItems: 'center', gap: 7 }, businessName: { flex: 1, fontSize: 12.5, fontWeight: '900' }, businessAmount: { fontSize: 20, fontWeight: '900' }, businessMeta: { fontSize: 8.7, lineHeight: 13 },
  metricGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 }, metric: { width: '31.5%', minHeight: 105, borderRadius: 19, borderWidth: 1, padding: 10 }, metricIcon: { width: 34, height: 34, borderRadius: 12, alignItems: 'center', justifyContent: 'center' }, metricValue: { fontSize: 12, fontWeight: '900', marginTop: 8 }, metricLabel: { fontSize: 8.2, lineHeight: 12, fontWeight: '800', marginTop: 4 },
  notice: { flexDirection: 'row', alignItems: 'center', gap: 11 }, noticeTitle: { fontSize: 14, fontWeight: '900' }, noticeText: { fontSize: 10.5, lineHeight: 16, marginTop: 4 },
  bankCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 11 }, bankIcon: { width: 47, height: 47, borderRadius: 16, alignItems: 'center', justifyContent: 'center' }, bankTitle: { fontSize: 15, fontWeight: '900' }, bankName: { fontSize: 9.5, marginTop: 4 }, iban: { fontSize: 13.5, fontWeight: '900', letterSpacing: 0.5, marginTop: 8 }, bankNote: { fontSize: 9.5, lineHeight: 14, marginTop: 6 },
  formCard: { gap: 13 }, formTitleRow: { flexDirection: 'row', alignItems: 'center', gap: 10 }, formIcon: { width: 45, height: 45, borderRadius: 15, alignItems: 'center', justifyContent: 'center' }, formTitle: { fontSize: 16, fontWeight: '900' }, formText: { fontSize: 10.5, lineHeight: 16, marginTop: 3 },
  receiptPicker: { minHeight: 76, borderRadius: 18, borderWidth: 1, padding: 10, flexDirection: 'row', alignItems: 'center', gap: 10 }, receiptPreview: { width: 54, height: 54, borderRadius: 14 }, receiptPlaceholder: { width: 54, height: 54, borderRadius: 14, alignItems: 'center', justifyContent: 'center' }, receiptTitle: { fontSize: 13, fontWeight: '900' }, receiptText: { fontSize: 9.5, marginTop: 4 }, removeReceipt: { fontSize: 11, fontWeight: '900', textAlign: 'center' },
  toggleRow: { minHeight: 72, borderRadius: 17, padding: 12, flexDirection: 'row', alignItems: 'center', gap: 10 }, toggleTitle: { fontSize: 13.5, fontWeight: '900' }, toggleText: { fontSize: 9.5, lineHeight: 14, marginTop: 4 }, fieldLabel: { fontSize: 9, fontWeight: '900', letterSpacing: 1 }, segment: { flexDirection: 'row', gap: 8 }, choice: { flex: 1, minHeight: 50, borderRadius: 15, borderWidth: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7 }, choiceText: { fontSize: 11, fontWeight: '900' }, choiceWrap: { flexDirection: 'row', flexWrap: 'wrap', gap: 7 }, smallChoice: { minWidth: 48, minHeight: 41, borderRadius: 13, borderWidth: 1, paddingHorizontal: 10, alignItems: 'center', justifyContent: 'center' }, smallChoiceText: { fontSize: 10, fontWeight: '900' },
  listTitle: { fontSize: 18, fontWeight: '900', marginTop: 3 }, reportCard: { gap: 10 }, reportIcon: { width: 44, height: 44, borderRadius: 15, alignItems: 'center', justifyContent: 'center' }, rowTitle: { fontSize: 13.5, fontWeight: '900' }, rowMeta: { fontSize: 9.2, lineHeight: 14, marginTop: 3 }, rowAmount: { fontSize: 13, fontWeight: '900' }, note: { fontSize: 10.5, lineHeight: 16 }, allocationWrap: { gap: 6 }, allocation: { minHeight: 42, borderRadius: 12, paddingHorizontal: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, allocationText: { fontSize: 8.5 }, allocationAmount: { fontSize: 10.5, fontWeight: '900' }, receiptOpen: { minHeight: 43, borderRadius: 13, borderWidth: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7 }, receiptOpenText: { fontSize: 10.5, fontWeight: '900' }, adminNote: { minHeight: 44, borderRadius: 13, borderWidth: 1, padding: 10, flexDirection: 'row', alignItems: 'center', gap: 7 }, adminNoteText: { flex: 1, fontSize: 9.5, lineHeight: 14 }, reviewBox: { gap: 9 }, actionRow: { flexDirection: 'row', gap: 8 }, actionButton: { flex: 1, minHeight: 46, borderRadius: 14, borderWidth: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 }, actionText: { fontSize: 11, fontWeight: '900' }, cancelButton: { minHeight: 42, borderWidth: 1, borderRadius: 13, alignItems: 'center', justifyContent: 'center' }, cancelText: { fontSize: 10.5, fontWeight: '900' },
  periodCard: { gap: 10 }, periodIcon: { width: 44, height: 44, borderRadius: 15, alignItems: 'center', justifyContent: 'center' }, periodMetrics: { flexDirection: 'row', gap: 6 }, mini: { flex: 1, minWidth: 0, minHeight: 57, borderRadius: 13, padding: 8, justifyContent: 'center' }, miniValue: { fontSize: 10, fontWeight: '900' }, miniLabel: { fontSize: 7.5, fontWeight: '800', marginTop: 4 }, chargeCard: { gap: 8 }, chargeIcon: { width: 42, height: 42, borderRadius: 14, alignItems: 'center', justifyContent: 'center' },
});
