  ...
  useEffect(() => {
    ...
    if (target) {
      ...
      if (isAdmin && target === 'team' && navigationTarget.targetSection === 'platform') {
        ...
        const reportId = typeof data.focus_payment_report_id === 'string'
          ? data.focus_payment_report_id
          : typeof data.payment_report_id === 'string'
            ? data.payment_report_id
            : undefined;
        const workshopId = typeof data.workshop_id === 'string'
          ? data.workshop_id
