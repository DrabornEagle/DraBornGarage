...
const styles = StyleSheet.create({
  content: { paddingHorizontal: 18, paddingTop: 56, paddingBottom: 120, gap: 15 }, tabs: { flexDirection: 'row', gap: 5, padding: 5, borderWidth: 1, borderRadius: 18 }, tab: { flex: 1, minHeight: 48, borderWidth: 1, borderColor: 'transparent', borderRadius: 14, alignItems: 'center', justifyContent: 'center', gap: 3 }, tabText: { fontSize: 12, fontWeight: '900', textAlign: 'center' }, sectionGap: { gap: 14 }, dateRow: { gap: 8, paddingRight: 12 }, dateChip: { minWidth: 90, minHeight: 45, borderWidth: 1, borderRadius: 14, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 9 }, dateText: { fontSize: 12.5, fontWeight: '900' }, filterRow: { gap: 8, paddingRight: 12 }, filterChip: { minHeight: 40, borderWidth: 1, borderRadius: 999, paddingHorizontal: 13, alignItems: 'center', justifyContent: 'center' }, filterText: { fontSize: 12.5, fontWeight: '900' }, statsRow: { flexDirection: 'row', gap: 7 }, miniStat: { flex: 1, minHeight: 70, borderWidth: 1, borderRadius: 16, padding: 10, justifyContent: 'center' }, miniValue: { fontSize: 20, fontWeight: '900' }, miniLabel: { fontSize: 12, marginTop: 4 }, sectionTitle: { fontSize: 18, fontWeight: '900', marginTop: 2 }, empty: { alignItems: 'center', gap: 9, paddingVertical: 30 }, emptyTitle: { fontSize: 17, fontWeight: '900' }, appointmentCard: { gap: 11 }, cardTop: { flexDirection: 'row', alignItems: 'center', gap: 10 }, timeBox: { width: 57, height: 57, borderRadius: 17, alignItems: 'center', justifyContent: 'center' }, time: { fontSize: 14, fontWeight: '900' }, timeEnd: { fontSize: 11, marginTop: 3 }, copy: { flex: 1, minWidth: 0 }, cardTitle: { fontSize: 13, fontWeight: '900' }, cardMeta: { fontSize: 12.5, lineHeight: 16, marginTop: 3 }, status: { fontSize: 11, fontWeight: '900', maxWidth: 78, textAlign: 'right' }, note: { borderRadius: 14, padding: 10, flexDirection: 'row', gap: 7 }, noteText: { flex: 1, fontSize: 12, lineHeight: 15 }, actions: { flexDirection: 'row', flexWrap: 'wrap', gap: 7 }, action: { minHeight: 38, borderWidth: 1, borderRadius: 12, paddingHorizontal: 9, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 4 }, actionText: { fontSize: 12, fontWeight: '900' }, form: { gap: 13 }, formTitle: { fontSize: 19, fontWeight: '900' }, label: { fontSize: 12, fontWeight: '900', letterSpacing: 0.8 }, listChoices: { gap: 8 }, choice: { minHeight: 56, borderWidth: 1, borderRadius: 15, padding: 10, flexDirection: 'row', alignItems: 'center', gap: 8 }, choiceTitle: { fontSize: 13, fontWeight: '900' }, slotGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 }, slot: { minWidth: 68, minHeight: 41, borderWidth: 1, borderRadius: 13, alignItems: 'center', justifyContent: 'center' }, slotText: { fontSize: 12.5, fontWeight: '900' }, emptyText: { fontSize: 12.5, paddingVertical: 10 }, twoButtons: { flexDirection: 'row', gap: 8 }, flex: { flex: 1 }, hourCard: { gap: 12 }, hourHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, hourDay: { fontSize: 16, fontWeight: '900' }, toggle: { minWidth: 62, minHeight: 32, borderWidth: 1, borderRadius: 999, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 9 }, toggleText: { fontSize: 10, fontWeight: '900' }, twoCols: { flexDirection: 'row', gap: 9 }, offCard: { flexDirection: 'row', alignItems: 'center', gap: 10 }, setting: { minHeight: 56, borderWidth: 1, borderRadius: 16, padding: 11, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },   settingText: { fontSize: 13, fontWeight: '900' },
  ...
  attentionMeta: { fontSize: 12.5, lineHeight: 17, marginTop: 3 },
  ...
  attentionTimeText: { fontSize: 13, fontWeight: '900' },
  ...
  historyMeta: { fontSize: 12.5, marginTop: 4 },
  historyList: { gap: 16 },
  historyDay: { gap: 8 },
  ...
  pastTimeText: { fontSize: 13, fontWeight: '900' },
});
