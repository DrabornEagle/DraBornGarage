...
const styles = StyleSheet.create({
  content: { paddingHorizontal: 18, paddingTop: 56, paddingBottom: 120, gap: 14 }, tabs: { flexDirection: 'row', gap: 5, padding: 5, borderWidth: 1, borderRadius: 18 }, tab: { flex: 1, minHeight: 47, borderWidth: 1, borderColor: 'transparent', borderRadius: 14, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 }, tabText: { fontSize: 10, fontWeight: '900' }, badge: { minWidth: 20, height: 20, borderRadius: 10, alignItems: 'center', justifyContent: 'center' }, badgeText: { color: '#fff', fontSize: 9, fontWeight: '900' }, search: { minHeight: 54, borderWidth: 1, borderRadius: 18, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 15, gap: 10 }, searchInput: { flex: 1 }, form: { gap: 12 }, formTitle: { fontSize: 18, fontWeight: '900' }, customerCard: { padding: 14 }, customerTop: { flexDirection: 'row', alignItems: 'center', gap: 10 }, avatar: { width: 47, height: 47, borderRadius: 16, alignItems: 'center', justifyContent: 'center' }, avatarText: { fontSize: 19, fontWeight: '900' }, copy: { flex: 1, minWidth: 0 }, customerName: { fontSize: 15, fontWeight: '900' }, meta: { fontSize: 10, lineHeight: 14, marginTop: 3 }, debt: { fontSize: 11, fontWeight: '900' }, expanded: { borderTopWidth: 1, marginTop: 13, paddingTop: 12, gap: 9 }, bike: { borderWidth: 1, borderRadius: 18, padding: 11, gap: 9 }, bikeTop: { flexDirection: 'row', alignItems: 'center', gap: 9 }, bikeTitle: { fontSize: 13, fontWeight: '900' }, accessButton: { minHeight: 41, borderWidth: 1, borderRadius: 13, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 }, accessText: { fontSize: 10, fontWeight: '900' }, accessPanel: { borderWidth: 1, borderRadius: 17, padding: 12, alignItems: 'center', gap: 8 }, qr: { backgroundColor: '#fff', padding: 9, borderRadius: 14 }, codeLabel: { fontSize: 8, fontWeight: '900', letterSpacing: 1 }, code: { fontSize: 25, fontWeight: '900', letterSpacing: 3 }, addBike: { minHeight: 43, borderWidth: 1, borderStyle: 'dashed', borderRadius: 14, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 }, addBikeText: { fontSize: 11, fontWeight: '900' }, twoCol: { flexDirection: 'row', gap: 8 }, flex: { flex: 1 }, empty: { alignItems: 'center', gap: 8, paddingVertical: 28 }, emptyTitle: { fontSize: 16, fontWeight: '900' }, claim: { gap: 11 }, claimTop: { flexDirection: 'row', alignItems: 'center', gap: 10 }, claimTitle: { fontSize: 14, fontWeight: '900' }, claimStatus: { fontSize: 8, fontWeight: '900' }, claimActions: { flexDirection: 'row', gap: 8 }, action: { flex: 1, minHeight: 43, borderWidth: 1, borderRadius: 13, alignItems: 'center', justifyContent: 'center' }, actionText: { fontSize: 10, fontWeight: '900' },
});
