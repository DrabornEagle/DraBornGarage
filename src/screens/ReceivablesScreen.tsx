...
const styles = StyleSheet.create({
  ...
  heroLabel: { color: 'rgba(255,255,255,0.76)', fontSize: 9.5, fontWeight: '900', letterSpacing: 1 },
  heroValue: { color: '#fff', fontSize: 34, fontWeight: '900', marginTop: 7 },
  heroMeta: { color: 'rgba(255,255,255,0.76)', fontSize: 10.5, marginTop: 5 },
  ...
  heroSmall: { color: '#fff', fontSize: 11, fontWeight: '800' },
  summaryRow: { flexDirection: 'row', gap: 8 },
  summaryCard: { flex: 1, minWidth: 0, borderWidth: 1, borderRadius: 19, padding: 11, minHeight: 103 },
  summaryIcon: { width: 34, height: 34, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
  summaryValue: { fontSize: 13, fontWeight: '900', marginTop: 9 },
  summaryLabel: { fontSize: 8.5, fontWeight: '800', marginTop: 3 },
  searchCard: { padding: 12 },
  filters: { gap: 8, paddingRight: 16 },
  filter: { minHeight: 42, borderWidth: 1, borderRadius: 999, paddingHorizontal: 13, flexDirection: 'row', alignItems: 'center', gap: 6 },
  filterText: { fontSize: 10, fontWeight: '900' },
  card: { borderWidth: 1, borderRadius: 23, padding: 14, gap: 12 },
  cardTop: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  cardIcon: { width: 46, height: 46, borderRadius: 15, alignItems: 'center', justifyContent: 'center' },
  copy: { flex: 1, minWidth: 0 },
  cardTitle: { fontSize: 14, fontWeight: '900' },
  cardMeta: { fontSize: 9.5, lineHeight: 14, marginTop: 3 },
  badge: { maxWidth: 108, borderWidth: 1, borderRadius: 999, paddingHorizontal: 9, paddingVertical: 6 },
  badgeText: { fontSize: 8, fontWeight: '900', textAlign: 'center' },
  complaint: { fontSize: 11.5, lineHeight: 17 },
  amountGrid: { flexDirection: 'row', gap: 7 },
  amountBox: { flex: 1, minWidth: 0, borderRadius: 14, padding: 9, minHeight: 62, justifyContent: 'center' },
  amountLabel: { fontSize: 7.5, fontWeight: '900' },
  amountValue: { fontSize: 11.5, fontWeight: '900', marginTop: 5 },
  dueRow: { borderTopWidth: 1, paddingTop: 11, flexDirection: 'row', alignItems: 'center', gap: 7 },
  dueText: { flex: 1, fontSize: 10.5 },
  empty: { alignItems: 'center', gap: 9, paddingVertical: 32 },
  emptyTitle: { fontSize: 17, fontWeight: '900' },
  emptyText: { fontSize: 11.5, lineHeight: 18, textAlign: 'center', paddingVertical: 8 },
  ...
  detailPaid: { color: '#fff', fontSize: 17, fontWeight: '900', marginTop: 7 },
  stack: { gap: 12 },
  customerMessage: { borderWidth: 1, borderRadius: 15, padding: 11, fontSize: 11, lineHeight: 17 },
  sectionTitle: { fontSize: 18, fontWeight: '900' },
  sectionSub: { fontSize: 10.5, lineHeight: 16, marginTop: 4 },
  ...
  listRow: { minHeight: 64, flexDirection: 'row', alignItems: 'center', gap: 9, paddingVertical: 9 },
  ...
  noteText: { fontSize: 11.5, lineHeight: 17, fontWeight: '700' },
  ...
  eventNote: { fontSize: 10.5, lineHeight: 15, marginTop: 4 },
});
