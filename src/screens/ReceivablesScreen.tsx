...
const styles = StyleSheet.create({
  ...
  heroLabel: { color: 'rgba(255,255,255,0.76)', fontSize: 11, fontWeight: '900', letterSpacing: 1 },
  heroValue: { color: '#fff', fontSize: 34, fontWeight: '900', marginTop: 7 },
  heroMeta: { color: 'rgba(255,255,255,0.76)', fontSize: 12, marginTop: 5 },
  ...
  heroSmall: { color: '#fff', fontSize: 12.5, fontWeight: '800' },
  ...
  summaryLabel: { fontSize: 10, fontWeight: '800', marginTop: 3 },
  ...
  cardMeta: { fontSize: 11, lineHeight: 14, marginTop: 3 },
  ...
  complaint: { fontSize: 12.5, lineHeight: 17 },
  ...
  amountLabel: { fontSize: 9.5, fontWeight: '900' },
  amountValue: { fontSize: 12.5, fontWeight: '900', marginTop: 5 },
  dueRow: { borderTopWidth: 1, paddingTop: 11, flexDirection: 'row', alignItems: 'center', gap: 7 },
  dueText: { flex: 1, fontSize: 12 },
  empty: { alignItems: 'center', gap: 9, paddingVertical: 32 },
  emptyTitle: { fontSize: 17, fontWeight: '900' },
  emptyText: { fontSize: 12.5, lineHeight: 18, textAlign: 'center', paddingVertical: 8 },
  ...
  stack: { gap: 12 },
  customerMessage: { borderWidth: 1, borderRadius: 15, padding: 11, fontSize: 12.5, lineHeight: 17 },
  ...
  noteText: { fontSize: 12.5, lineHeight: 17, fontWeight: '700' },
  ...
  eventNote: { fontSize: 12, lineHeight: 15, marginTop: 4 },
});
