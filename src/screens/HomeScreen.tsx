  ...
  return (
    ...
    >
      ...
      {canWork && panelMode === 'mechanic' && (
        <View>
          <Text style={[styles.availabilityTitle, { color: colors.text }]}>Çalışma Durumum</Text>
          <Text style={[styles.availabilityHint, { color: colors.textMuted }]}>Müsait: yeni iş alırım • Meşgul: mevcut işe odaklanırım • Kapalı: iş almam</Text>
...
const styles = StyleSheet.create({
  ...
  availabilityTitle: { fontSize: 17, fontWeight: '900' },
  availabilityHint: { fontSize: 10.5, lineHeight: 16, marginTop: 4, marginBottom: 9 },
  ...
  hero: { borderRadius: 28, padding: 21, minHeight: 170, overflow: 'hidden', justifyContent: 'space-between' },
