...
export function SettingsScreen() {
  ...
  return <ScrollView contentContainerStyle={styles.content}>
    ...
    <GlassCard style={styles.info}><Info icon="layers" label="Sürüm" value="v0.4.0 • Ek işlem, müşteri onayı ve servis detayları" /><Info icon="archive" label="Bu sürüm öncesi yedek" value="backup/v0.3.1-before-v0.4.0" /><Info icon="refresh" label="Veritabanı geri alma" value="rollback_v0_4_0_to_v0_3_1.sql" /><Info icon="phone-portrait" label="Test yöntemi" value="Expo Go • SDK 54" /><Info icon="cube" label="APK/AAB planı" value="v1.0" /></GlassCard>
