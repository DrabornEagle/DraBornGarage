...
export function SettingsScreen() {
  ...
  return <ScrollView contentContainerStyle={styles.content}>
    ...
    <GlassCard style={styles.info}><Info icon="layers" label="Sürüm" value="v0.8.5 • Rol Ayrımı ve Personel Başvuruları" /><Info icon="notifications" label="Bildirim motoru" value="Canlı uygulama içi + yerel telefon hatırlatması" /><Info icon="archive" label="Bu sürüm öncesi yedek" value="backup/v0.8.4-before-v0.8.5" /><Info icon="refresh" label="Geri alma" value="Kod yedeğiyle v0.8.4" /><Info icon="phone-portrait" label="Test yöntemi" value="Expo Go • SDK 54 • Yerel bildirim" /><Info icon="cube" label="APK/AAB ve uzaktan push" value="v1.0 geliştirme yapısı" /></GlassCard>
...
const styles = StyleSheet.create({
  content: { paddingHorizontal: 18, paddingTop: 56, paddingBottom: 120, gap: 15 }, profile: { flexDirection: 'row', alignItems: 'center', gap: 11 }, avatar: { width: 54, height: 54, borderRadius: 19, alignItems: 'center', justifyContent: 'center' }, avatarText: { color: '#fff', fontSize: 21, fontWeight: '900' }, copy: { flex: 1, minWidth: 0 }, name: { fontSize: 17, fontWeight: '900' }, meta: { fontSize: 11, marginTop: 4 }, modeCard: { minHeight: 80, borderWidth: 1, borderRadius: 21, padding: 13, flexDirection: 'row', alignItems: 'center', gap: 10 }, modeIcon: { width: 48, height: 48, borderRadius: 16, alignItems: 'center', justifyContent: 'center' }, modeTitle: { fontSize: 14, fontWeight: '900' }, modeText: { fontSize: 12, lineHeight: 16, marginTop: 4 }, sectionTitle: { fontSize: 18, fontWeight: '900', marginTop: 3 }, themeList: { gap: 9 }, theme: { minHeight: 79, borderWidth: 1, borderRadius: 20, padding: 11, flexDirection: 'row', alignItems: 'center', gap: 11 }, preview: { width: 55, height: 55, borderRadius: 17, alignItems: 'center', justifyContent: 'center' }, themeTitle: { fontSize: 14, fontWeight: '900' }, themeSub: { fontSize: 10.5, marginTop: 4 }, demoCard: { gap: 13 }, demoHeader: { flexDirection: 'row', alignItems: 'center', gap: 11 }, demoTitle: { fontSize: 16, fontWeight: '900' }, demoText: { fontSize: 11, marginTop: 4 }, info: { paddingVertical: 2, paddingHorizontal: 14 }, infoRow: { minHeight: 65, borderBottomWidth: 1, flexDirection: 'row', alignItems: 'center', gap: 11 }, infoLabel: { fontSize: 9, fontWeight: '900' }, infoValue: { fontSize: 13, fontWeight: '800', marginTop: 4 }, logout: { minHeight: 54, borderWidth: 1, borderRadius: 18, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 }, logoutText: { fontSize: 13, fontWeight: '900' },
});
