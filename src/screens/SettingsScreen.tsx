...
export function SettingsScreen() {
  ...
  return <ScrollView contentContainerStyle={styles.content}>
    ...
    <SettingsAccordion title="Uygulama" subtitle="v1.0.0 RC • İlk Release APK test süreci" icon="information-circle" accent={colors.green} open={openSection === 'app'} onToggle={() => toggleSection('app')}>
      <GlassCard style={styles.info}><Info icon="layers" label="Sürüm" value="v1.0.0 RC • Release APK Adayı" /><Info icon="shield-checkmark" label="Motor Hazır kuralı" value="Son net ücret girilmeden Motor Hazır yapılamaz" /><Info icon="key" label="Şifre güvenliği" value="10 karakter + karmaşıklık + yaygın şifre engeli" /><Info icon="archive" label="Bu sürüm öncesi yedek" value="backup/v0.9.7-before-v1.0-20260714" /><Info icon="refresh" label="Geri alma" value="Kod yedeğiyle v0.9.7" /><Info icon="phone-portrait" label="Test yöntemi" value="GitHub Release APK + fiziksel cihaz testleri" /><Info icon="storefront" label="Mağaza durumu" value="APK testinde • AAB henüz yayınlanmadı" /></GlassCard>
    </SettingsAccordion>
