...
export function SettingsScreen() {
  ...
  return <ScrollView contentContainerStyle={styles.content}>
    ...
    <SettingsAccordion title="Uygulama" subtitle="v0.8.15 • sürüm ve sistem bilgileri" icon="information-circle" accent={colors.green} open={openSection === 'app'} onToggle={() => toggleSection('app')}>
      <GlassCard style={styles.info}><Info icon="layers" label="Sürüm" value="v0.8.15 • Modern Tahsilat ve Otomatik Teslim" /><Info icon="notifications" label="Bildirim motoru" value="Canlı uygulama içi + yerel telefon hatırlatması" /><Info icon="archive" label="Bu sürüm öncesi yedek" value="backup/v0.8.14-before-v0.8.15-20260713" /><Info icon="refresh" label="Geri alma" value="Kod yedeğiyle v0.8.14" /><Info icon="phone-portrait" label="Test yöntemi" value="Expo Go • SDK 54 • Yerel bildirim" /><Info icon="cube" label="APK/AAB ve uzaktan push" value="v1.0 geliştirme yapısı" /></GlassCard>
    </SettingsAccordion>
