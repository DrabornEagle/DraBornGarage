...
export function SettingsScreen() {
  ...
  return <ScrollView contentContainerStyle={styles.content}>
    ...
    <SettingsAccordion title="Uygulama" subtitle="v0.8.17 • sürüm ve sistem bilgileri" icon="information-circle" accent={colors.green} open={openSection === 'app'} onToggle={() => toggleSection('app')}>
      <GlassCard style={styles.info}><Info icon="layers" label="Sürüm" value="v0.8.17 • Sesli Push ve Ödeme Odağı" /><Info icon="notifications" label="Bildirim motoru" value="Canlı merkez + özel ses + native kapalı uygulama pushu" /><Info icon="archive" label="Bu sürüm öncesi yedek" value="backup/v0.8.16-before-v0.8.17-20260714" /><Info icon="refresh" label="Geri alma" value="Kod yedeğiyle v0.8.16" /><Info icon="phone-portrait" label="Test yöntemi" value="Expo Go arayüz testi • Native APK push/ses testi" /><Info icon="cube" label="APK/AAB ve uzaktan push" value="v0.8.17 EAS preview APK ile aktif" /></GlassCard>
    </SettingsAccordion>
