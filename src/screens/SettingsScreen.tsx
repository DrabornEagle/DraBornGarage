...
export function SettingsScreen() {
  ...
  return <ScrollView contentContainerStyle={styles.content}>
    ...
    <GlassCard style={styles.info}><Info icon="layers" label="Sürüm" value="v0.8.8 • Bildirim, Rapor ve Sportbike Arayüzü" /><Info icon="notifications" label="Bildirim motoru" value="Canlı uygulama içi + yerel telefon hatırlatması" /><Info icon="archive" label="Bu sürüm öncesi yedek" value="backup/v0.8.7-before-v0.8.8-ui-fix-20260712" /><Info icon="refresh" label="Geri alma" value="Kod yedeğiyle v0.8.7" /><Info icon="phone-portrait" label="Test yöntemi" value="Expo Go • SDK 54 • Yerel bildirim" /><Info icon="cube" label="APK/AAB ve uzaktan push" value="v1.0 geliştirme yapısı" /></GlassCard>
