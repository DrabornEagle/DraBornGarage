...
const styles = StyleSheet.create({
  root: { gap: 14 }, hero: { flexDirection: 'row', alignItems: 'center', gap: 12 }, heroIcon: { width: 54, height: 54, borderRadius: 18, alignItems: 'center', justifyContent: 'center' }, copy: { flex: 1, minWidth: 0 }, heroTitle: { fontSize: 17, fontWeight: '900' }, heroText: { fontSize: 12.5, lineHeight: 17, marginTop: 4 }, methods: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 }, method: { width: '48.7%', minHeight: 64, borderWidth: 1, borderRadius: 17, padding: 11, flexDirection: 'row', alignItems: 'center', gap: 8 }, methodText: { flex: 1, fontSize: 12.5, fontWeight: '900' }, form: { gap: 13 }, scan: { minHeight: 70, borderWidth: 1, borderRadius: 17, padding: 12, flexDirection: 'row', alignItems: 'center', gap: 10 }, scanTitle: { fontSize: 13, fontWeight: '900' }, scanText: { fontSize: 12, marginTop: 3 }, pendingTitle: { fontSize: 15, fontWeight: '900' }, pendingRow: { minHeight: 60, borderTopWidth: 1, flexDirection: 'row', alignItems: 'center', gap: 8 }, pendingName: { fontSize: 13, fontWeight: '900' }, pendingMeta: { fontSize: 12, marginTop: 3 }, pendingBadge: { fontSize: 10, fontWeight: '900' }, modal: { flex: 1, backgroundColor: 'rgba(0,0,0,0.85)', justifyContent: 'flex-end' }, scannerCard: { padding: 18, paddingBottom: 34, borderTopLeftRadius: 28, borderTopRightRadius: 28, gap: 15 }, scannerHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }, scannerTitle: { fontSize: 19, fontWeight: '900' }, camera: { height: 380, borderRadius: 24, overflow: 'hidden' }, frame: { position: 'absolute', width: 230, height: 230, borderWidth: 4, borderRadius: 24, left: '50%', top: '50%', marginLeft: -115, marginTop: -115 },
});
