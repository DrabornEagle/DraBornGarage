...
const styles = StyleSheet.create({
  content: { paddingHorizontal: 18, paddingTop: 56, paddingBottom: 32, gap: 14 }, form: { gap: 13 }, formTitle: { fontSize: 19, fontWeight: '900' }, label: { fontSize: 12, fontWeight: '900', letterSpacing: 0.8 }, chips: { gap: 8 }, choice: { minHeight: 58, borderWidth: 1, borderRadius: 16, padding: 11, flexDirection: 'row', alignItems: 'center', gap: 8 }, copy: { flex: 1, minWidth: 0 }, choiceTitle: { fontSize: 13, fontWeight: '900' }, choiceSub: { fontSize: 12, marginTop: 3 }, dateRow: { gap: 8, paddingRight: 12 }, dateChip: { minWidth: 90, minHeight: 45, borderWidth: 1, borderRadius: 14, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 10 }, dateText: { fontSize: 12, fontWeight: '900' }, slotGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 }, slot: { minWidth: 70, minHeight: 42, borderWidth: 1, borderRadius: 13, alignItems: 'center', justifyContent: 'center' }, slotText: { fontSize: 13, fontWeight: '900' }, emptyText: { fontSize: 13, paddingVertical: 10 }, sectionTitle: { fontSize: 18, fontWeight: '900', marginTop: 3 }, empty: { alignItems: 'center', gap: 8, paddingVertical: 28 }, emptyTitle: { fontSize: 16, fontWeight: '900' }, card: { gap: 11 }, cardTop: { flexDirection: 'row', alignItems: 'center', gap: 10 }, icon: { width: 46, height: 46, borderRadius: 15, alignItems: 'center', justifyContent: 'center' }, cardTitle: { fontSize: 14, fontWeight: '900' }, cardMeta: { fontSize: 12, marginTop: 3 }, status: { fontSize: 11, fontWeight: '900', maxWidth: 85, textAlign: 'right' }, info: { minHeight: 64, borderRadius: 16, padding: 11, flexDirection: 'row', alignItems: 'center', gap: 9 }, infoTitle: { fontSize: 13, fontWeight: '900' }, infoSub: { fontSize: 12, marginTop: 4 }, cancel: { minHeight: 44, borderWidth: 1, borderRadius: 14, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 }, cancelText: { fontSize: 12.5, fontWeight: '900' },
});
