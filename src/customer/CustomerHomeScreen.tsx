...
const styles = StyleSheet.create({
  ...
  workshopText: { flexShrink: 1, fontSize: 12.5, fontWeight: '900' },
  hero: { minHeight: 150, borderRadius: 26, padding: 20, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  heroLabel: { color: 'rgba(255,255,255,0.75)', fontSize: 12, fontWeight: '900', letterSpacing: 1 },
  ...
  cardMeta: { fontSize: 12.5, lineHeight: 16, marginTop: 4 },
  sectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end' },
  sectionTitle: { fontSize: 18, fontWeight: '900' },
  sectionText: { fontSize: 13, marginTop: 4 },
  link: { fontSize: 12.5, fontWeight: '900' },
