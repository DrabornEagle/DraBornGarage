...
export function CustomerShell() {
  ...
  const tabs = useMemo(() => [
    ...
    { key: 'motorcycles' as const, label: 'Motorlar', icon: 'construct-outline' as const, active: 'construct' as const, a: colors.cyan, b: colors.primary2 },
...
const styles = StyleSheet.create({
  ...
  label: { fontSize: 10, fontWeight: '900', textAlign: 'center' },
