...
const styles = StyleSheet.create({
  flex: { flex: 1 }, navWrap: { position: 'absolute', left: 10, right: 10, bottom: 9, borderWidth: 1, borderRadius: 28, overflow: 'hidden', shadowOpacity: 0.25, shadowRadius: 20, elevation: 15 }, navBlur: { overflow: 'hidden' }, navBackdrop: { minHeight: 88 }, rail: { height: 4, flexDirection: 'row' }, railItem: { flex: 1, transform: [{ skewX: '-24deg' }] }, navInner: { minHeight: 82, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 2, paddingTop: 6, paddingBottom: 7 }, navItem: { flex: 1, alignItems: 'center', gap: 2 }, iconShell: { width: 43, height: 42, alignItems: 'center', justifyContent: 'center' }, activeIcon: { width: 42, height: 42, borderRadius: 14, alignItems: 'center', justifyContent: 'center' }, inactiveIcon: { width: 39, height: 39, borderRadius: 13, borderWidth: 1, alignItems: 'center', justifyContent: 'center' }, label: { fontSize: 8, fontWeight: '900', textAlign: 'center' }, line: { width: 17, height: 2.5, borderRadius: 3 },
});
