    ...
    return (
      <PremiumBackground>
        <View style={styles.loading}>
          <View style={[styles.logo, { backgroundColor: `${colors.primary}20` }]}><Ionicons name="construct" size={34} color={colors.primary} /></View>
...
const styles = StyleSheet.create({
  ...
  logo: { width: 74, height: 74, borderRadius: 25, alignItems: 'center', justifyContent: 'center' },
