...
export const VOICE_APPOINTMENT_CHANNEL_ID = 'draborngarage-voice-appointment-v9';
export const VOICE_CUSTOMER_LINK_CHANNEL_ID = 'draborngarage-voice-customer-link-v9';
export const VOICE_SERVICE_CHANNEL_ID = 'draborngarage-voice-service-v9';
export const VOICE_PAYMENT_CHANNEL_ID = 'draborngarage-voice-payment-v9';
export const VOICE_GENERIC_CHANNEL_ID = 'draborngarage-voice-generic-v9';
...
export async function ensureDraBornNotificationChannels() {
  ...
  const definitions: Array<[string, Notifications.NotificationChannelInput]> = [
    ...
    [VOICE_APPOINTMENT_CHANNEL_ID, { ...common, name: 'Türkçe Ses • Randevu', description: 'Yeni randevu var. Lütfen kontrol edin.', sound: 'garage_voice_appointment.wav', vibrationPattern: [0, 240, 90, 240, 90, 520] }],
    [VOICE_CUSTOMER_LINK_CHANNEL_ID, { ...common, name: 'Türkçe Ses • Müşteri Talebi', description: 'Yeni müşteri bağlantı talebi var. Lütfen kontrol edin.', sound: 'garage_voice_customer_link.wav', vibrationPattern: [0, 240, 90, 240, 90, 520] }],
    [VOICE_SERVICE_CHANNEL_ID, { ...common, name: 'Türkçe Ses • Servis', description: 'Yeni servis bildirimi var. Lütfen kontrol edin.', sound: 'garage_voice_service.wav', vibrationPattern: [0, 240, 90, 240, 90, 520] }],
    [VOICE_PAYMENT_CHANNEL_ID, { ...common, name: 'Türkçe Ses • Ödeme', description: 'Yeni ödeme bildirimi var. Lütfen kontrol edin.', sound: 'garage_voice_payment.wav', vibrationPattern: [0, 240, 90, 240, 90, 520] }],
    [VOICE_GENERIC_CHANNEL_ID, { ...common, name: 'Türkçe Sesli Uyarı', description: 'Yeni bildirim var. Lütfen kontrol edin.', sound: 'garage_voice_generic.wav', vibrationPattern: [0, 240, 90, 240, 90, 520] }],
