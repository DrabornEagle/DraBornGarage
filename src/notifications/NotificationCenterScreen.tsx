      ...
      <View style={[styles.page, { backgroundColor: colors.background, paddingTop: Math.max(insets.top, 16), paddingBottom: Math.max(insets.bottom, 12) }]}>
        ...
        <View style={styles.header}>
          <View style={styles.copy}>
            <Text style={[styles.eyebrow, { color: colors.primary }]}>v0.8 • CANLI BİLDİRİM MERKEZİ</Text>
...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 11, lineHeight: 17, marginTop: 3, maxWidth: 315 },
  ...
  heroEyebrow: { color: 'rgba(255,255,255,0.72)', fontSize: 8.5, fontWeight: '900', letterSpacing: 1 },
  heroValue: { color: '#fff', fontSize: 28, fontWeight: '900', lineHeight: 32 },
  heroText: { color: 'rgba(255,255,255,0.76)', fontSize: 9.3, lineHeight: 14, marginTop: 2 },
  ...
  tabText: { fontSize: 8.2, fontWeight: '900' },
  ...
  tabBadgeText: { color: '#fff', fontSize: 6.8, fontWeight: '900' },
  ...
  markAllText: { fontSize: 11, fontWeight: '900' },
  ...
  categoryText: { fontSize: 7.5, fontWeight: '900', letterSpacing: 0.5 },
  time: { fontSize: 8.2, fontWeight: '700' },
  notificationTitle: { fontSize: 13.5, fontWeight: '900', marginTop: 4 },
  notificationBody: { fontSize: 10.5, lineHeight: 16, marginTop: 4 },
  notificationFooter: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 7 },
  workshop: { flex: 1, fontSize: 8.3, fontWeight: '700' },
  ...
  emptyText: { fontSize: 10.5, lineHeight: 16, textAlign: 'center', maxWidth: 260 },
  ...
  cardText: { fontSize: 10, lineHeight: 15, marginTop: 4 },
  ...
  settingSubtitle: { fontSize: 9.2, lineHeight: 14, marginTop: 3 },
  infoCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 9 },
  infoText: { flex: 1, fontSize: 9.7, lineHeight: 15 },
});
